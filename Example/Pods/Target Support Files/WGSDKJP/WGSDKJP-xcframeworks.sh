...
install_xcframework "${PODS_ROOT}/../../WGSDKJP/Frameworks/WGSDK.xcframework" "WGSDK" "framework" "ios-arm64_armv7/WGSDK.framework" "ios-arm64_x86_64-simulator/WGSDK.framework"
